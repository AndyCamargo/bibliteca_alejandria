<%@ Page Language="C#" MasterPageFile="~/presentacion/MasterPage.master" AutoEventWireup="true" CodeFile="~/logica/registro_bibliotecario.aspx.cs" Inherits="presentacion_registro_bibliotecario" %>
        ...
        <table class="style1">
                        ...
                        <tr>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                    ControlToValidate="TB_cedula" ErrorMessage="Numeros de 0-12" 
                                    ValidationExpression="\d{7,12}" ValidationGroup="validar2"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="style2">
                            ...
                            <asp:TextBox ID="TB_telefono" runat="server" Width="267px"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                    ControlToValidate="TB_telefono" ErrorMessage="Numeros de 0-10" 
                                    ValidationExpression="\d{7,10}" ValidationGroup="validar2"></asp:RegularExpressionValidator>
                                                        </td>
                        </tr>
                        <tr>
                            <td class="style2">
                        ...
                        <tr>
                            ...
                            <asp:TextBox ID="TB_correo" runat="server" Width="268px"></asp:TextBox>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                                    ...
                                    ErrorMessage="Correo Incorrecto  &quot;ejemplo@algo.com&quot;" 
                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                                    ValidationGroup="validar2"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="style2">
            ...
            <tr>
                ...
                <asp:Button ID="BT_registro" runat="server" onclick="Button1_Click" 
                    Text="Registrar" Width="82px" ValidationGroup="validar2" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
